...
#if !UNITY_EDITOR && !UNITY_STANDALONE && !SteamworksNet_WIN && !SteamworksNet_LIN_OSX
			throw new System.InvalidOperationException("SteamworksNet functions can only be called on platforms that Steam is available on.");
#endif
		}
		...
		public static void TestIfAvailableClient() {
			...
			if (CSteamAPIContext.GetSteamClient() == System.IntPtr.Zero) {
				if (!CSteamAPIContext.Init()) {
					throw new System.InvalidOperationException("SteamworksNet is not initialized.");
				}
			}
		}
		...
		public static void TestIfAvailableGameServer() {
			...
			if (CSteamGameServerAPIContext.GetSteamClient() == System.IntPtr.Zero) {
				if (!CSteamGameServerAPIContext.Init()) {
					throw new System.InvalidOperationException("SteamworksNet GameServer is not initialized.");
				}
			}
		}

		// This continues to exist for both 'out string' and strings returned by SteamworksNet functions.
