...
#define DISABLESteamworksNet
	...
	#error Unsupported Unity platform. SteamworksNet.NET requires Unity 4.7 or higher.
#elif UNITY_4_7 || UNITY_5 || UNITY_2017 || UNITY_2017_1_OR_NEWER
	#if UNITY_EDITOR_WIN || (UNITY_STANDALONE_WIN && !UNITY_EDITOR)
		#define WINDOWS_BUILD
	#endif
#elif SteamworksNet_WIN
	#define WINDOWS_BUILD
#elif SteamworksNet_LIN_OSX
	// So that we don't enter the else block below.
#else
	#error You need to define SteamworksNet_WIN, or SteamworksNet_LIN_OSX. Refer to the readme for more details.
#endif
...
namespace SteamworksNet {
...
#elif SteamworksNet_WIN || SteamworksNet_LIN_OSX
	...
	public sealed class Callback<T> : IDisposable {
		...
		// Shouldn't ever get called here, but this is what C++ SteamworksNet does!
