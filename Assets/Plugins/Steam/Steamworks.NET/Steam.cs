...
namespace SteamworksNet {
	public static class Version {
		public const string SteamworksNetNETVersion = "14.0.0";
		public const string SteamworksNetSDKVersion = "1.48";
	...
	public static class SteamAPI {
		...
		public static bool Init() {
			...
			// SteamworksNet.NET specific: We initialize the SteamAPI Context like this for now, but we need to do it
		...
		// Dispatch all queued SteamworksNet callbacks.
		//
