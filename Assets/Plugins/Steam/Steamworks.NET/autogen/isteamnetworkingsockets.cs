...
namespace SteamworksNet {
	public static class SteamNetworkingSockets {
		...
		/// <para> On Steam, callbacks are dispatched via the ordinary SteamworksNet callbacks mechanism.</para>
		...
		public static void RunCallbacks(out ISteamNetworkingSocketsCallbacks pCallbacks) {
			InteropHelp.TestIfAvailableClient();
			NativeMethods.ISteamNetworkingSockets_RunCallbacks(CSteamAPIContext.GetSteamNetworkingSockets(), out pCallbacks);
		}
#endif
	}
}
