...
namespace SteamworksNet {
	public static class SteamGameServerInventory {
		...
		/// <para> See your SteamworksNet configuration to set playtime drop rates for individual itemdefs.</para>
		...
		/// <para> defined via SteamworksNet configuration, and not necessarily contiguous integers).</para>
