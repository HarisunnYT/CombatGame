...
#elif UNITY_STANDALONE_WIN || SteamworksNet_WIN
	#define VALVE_CALLBACK_PACK_LARGE
#elif UNITY_STANDALONE_LINUX || UNITY_STANDALONE_OSX || SteamworksNet_LIN_OSX
	#define VALVE_CALLBACK_PACK_SMALL
...
#else
	#define VALVE_CALLBACK_PACK_LARGE
	#warning You need to define SteamworksNet_WIN, or SteamworksNet_LIN_OSX. Refer to the readme for more details.
#endif
