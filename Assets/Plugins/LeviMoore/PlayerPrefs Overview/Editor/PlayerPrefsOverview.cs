...
public class PlayerPrefsOverview : EditorWindow
{
    ...
    readonly List<string> ignoreKeys = new List<string>() { "UnityGraphicsQuality", "PlayerPrefsOverview_SortType", "PlayerPrefsOverview_SearchWord", "PlayerPrefsOverview_SearchType" };

    private Vector2 scrollPos;
    private bool selectedAllMixed;
    private bool selectedAll;
    private bool autoRefresh;
    private readonly float autoRefreshRate = 1.5f;
